        ...
        <Form onSubmit={handleSubmit} className="border p-4 shadow">
          ...
          <div className="mb-3 d-flex ">
            <Button variant="danger" onMouseEnter={handleShowSocialButtons}>
              <FaGoogle /> <Link to={Config.url_google} style={{ textDecoration: 'none', color: 'white' }}> Google</Link>
            </Button>
            <span style={{ width: '10px' }}></span>
            <Button variant="primary" onMouseEnter={handleShowSocialButtons}>
              <FaFacebook /> <Link to={Config.url_facebook} style={{ textDecoration: 'none', color: 'white' }}>Facebook</Link>
            </Button>
            <span style={{ width: '10px' }}></span>
            <Button variant="info" onMouseEnter={handleShowSocialButtons}>
              <FaLinkedin /> <Link to={Config.url_linkedin} style={{ textDecoration: 'none', color: 'white' }}> LinkedIn</Link>
            </Button>
          </div>
        </Form>
      </Container>
